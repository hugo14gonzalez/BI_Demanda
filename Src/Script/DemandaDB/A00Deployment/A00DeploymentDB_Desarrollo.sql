...
:setvar DATABASE_PATH_LOG_DW "C:\MSDB\DemandaDW"
:setvar DATABASE_PATH_PRIMARY_DW "C:\MSDB\DemandaDW"
:setvar DATABASE_PATH_DEMANDADW_DAT "C:\MSDB\DemandaDW"
:setvar DATABASE_PATH_DEMANDADW_IND "C:\MSDB\DemandaDW"

/* Produccion: C:\MSDB\DemandaDW, Desarrollo: C:\MSDB\Pruebas\DemandaDW */
:setvar DATABASE_PATH_DEMANDA_DAT "C:\MSDB\DemandaDW"
:setvar DATABASE_PATH_DEMANDA_IND "C:\MSDB\DemandaDW"
...
:setvar DATABASEOLAP_STORAGEPATH "C:\MSDB\Demanda_OLAP\"
...
:setvar DATABASE_PROXYPASSWORD ""

:setvar LINKSERVER_NAME_Demanda_OLAP "Demanda_OLAP"

PRINT '------------------------------------------------------------------------';
PRINT 'START DEPLOYMENT: A00DeploymentDB_Desarrollo.sql';
PRINT '------------------------------------------------------------------------';
...
PRINT '------------------------------------------------------------------------';
PRINT 'END DEPLOYMENT: A00DeploymentDB_Desarrollo.sql'
PRINT '------------------------------------------------------------------------';
GO
