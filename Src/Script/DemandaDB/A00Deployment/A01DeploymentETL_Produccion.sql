...
:setvar DATABASE_SERVERNAME_SSIS "MVMOAN172A\SQL2019"
...
:setvar SSISDB_PATH_ERROR "\\MVMOAN172A\ETL_Log\DemandaBI\Error"
:setvar SSISDB_PATH_PROCESADOS "\\MVMOAN172A\ETL_Log\DemandaBI\Procesados"
:setvar SSISDB_PATH_SINPROCESAR "\\MVMOAN172A\ETL_Log\DemandaBI\SinProcesar"
:setvar SSISDB_PATH_LOG "\\MVMOAN172A\ETL_Log\DemandaBI"

PRINT '------------------------------------------------------------------------';
PRINT 'START DEPLOYMENT: A01DeploymentETL_Produccion.sql';
PRINT '------------------------------------------------------------------------';
...
PRINT '------------------------------------------------------------------------';
PRINT 'END DEPLOYMENT: A01DeploymentETL_Produccion.sql'
PRINT '------------------------------------------------------------------------';
GO
